...
public class ColorPickerActivity extends FragmentActivity {
	...
	public static class HSVPagerAdapter extends FragmentStatePagerAdapter {
		...
		private ColorModel mNextAdapterColorModel;
		...
		public void stepColor(){
			mAdapterColorModel = mNextAdapterColorModel;
			mNextAdapterColorModel = null;
		}
		...
		public Fragment getItem(int position) {
			if (mNextAdapterColorModel != null){
				stepColor();				
			}
			...
			args.putInt(ColorObjectFragment.ARG_COLOR_INT,
					mNextAdapterColorModel.getColor());
			fragment.setArguments(args);
			mHexCodeMap.put(position, mNextAdapterColorModel.getHexCode());
			...
			Log.d("awe", "mAdapterColorModel = "+mAdapterColorModel.getHexCode());
			Log.d("awe", "mNextAdapterColorModel = "+mNextAdapterColorModel.getHexCode());
			return fragment;
		}
		...
		private void setNextColor(int position){
			...
			mNextAdapterColorModel = new ColorModel(hsv_temp);
		}
